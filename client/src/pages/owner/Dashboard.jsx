...
const Dashboard = () => {
  ...
  const { axios, isOwner, currency, checkingAuth, navigate } = useAppContext()
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Car Owner Dashboard" subTitle="Monitor overall platform performance including total cars, bookings, revenue, and recent activities" />
